...
//		Image image = new ImageIcon(this.getClass().getResource("../../Images/image12.png")).getImage();
//		lblNewLabel.setIcon(new ImageIcon(image));
		lblNewLabel.setBounds(0, 530, 275, 183);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("");
//		Image image1 = new ImageIcon(this.getClass().getResource("../../Images//image11.png")).getImage();
//		lblNewLabel_1.setIcon(new ImageIcon(image1));
		lblNewLabel_1.setBounds(0, 384, 275, 147);
		contentPane.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("");
//		Image image2 = new ImageIcon(this.getClass().getResource("../../Images//images.png")).getImage();
...
//		Image img8 = new ImageIcon(this.getClass().getResource("../../Images//5.PNG")).getImage();
